...
function buttonScrollAppetizerFavourites(direction) {
  const categoryContainers = document
    .getElementById("cards-container-favourites")
    .getElementsByClassName("category-container-favourites")[0];
...
function buttonScrollMainFavourites(direction) {
  const categoryContainers = document
    .getElementById("cards-container-favourites")
    .getElementsByClassName("category-container-favourites")[1];
...
function buttonScrollDessertFavourites(direction) {
  const categoryContainers = document
    .getElementById("cards-container-favourites")
    .getElementsByClassName("category-container-favourites")[2];
